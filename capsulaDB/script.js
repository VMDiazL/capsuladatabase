...
function downloadCertificate() {
    ...
    certTextEl.innerHTML = `
        <div style="text-align: center; padding: 5px; position: relative;">
            <h4 style="font-size: 1.2em; color: #006657; margin-top: 0; margin-bottom: 10px;">${certificateTitle}</h4>
            ...
            <div style="margin-top: 20px; margin-bottom:15px; display: flex; justify-content: space-around; align-items: center;">
                 <div style="text-align: center;">
                    ...
                    <p style="font-size: 0.85em; font-weight: bold; color: #006657; margin-top: 1px;">${asesorName}</p>
                </div>
            </div>
            <p style="font-size: 0.7em; color: #333; margin-top: 15px;">Fecha de emisión: ${formattedDate}</p>
        </div>`;
